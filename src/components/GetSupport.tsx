      ...
      >
        <Box sx={style}>
          ...
          <Typography>
            ...
            contactus@deltainsurance.com.au or by phone on (07) 3017 4720.
          </Typography>
          <Typography variant="h5">
            What can I do in the Portal? The Portal{" "}
          </Typography>
          <Typography>
            will provide an indicative price indication for our clients based on
            their size and business. You can then receive this by email, along
            with a proposal formor completion if you would like to proceed to
            obtain a full quote. The Portal is designed to be used both on
            laptops and mobile devices, and can be accessed through the link on
            our website, deltainsurance.com.au
          </Typography>
          ...
          <Typography>
            ...
            be offering full quote functionality soon I have forgotten my
            password
          </Typography>
          <Typography>
            Please ask us for a password reset at contactus.deltainsurance.com
            au or by phone on (07) 3017 4720.
          </Typography> */}
        </Box>
      </Modal>
    </div>
